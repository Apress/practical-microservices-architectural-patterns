cd D:\binil\gold\shuffle\pack02\ch17\ch17-01\Ax2-Ecom-No-Security
mvn eclipse:eclipse
...
mongoimport --db ecom --jsonArray --collection productCategory --file D://binil/gold/pack03/ch17/ch17-01/Ax2-Ecom-No-Security/Ecom-xtra-setup/productCategory.json

2)Load product data
--------------------------

mongoimport --db ecom --jsonArray --collection product --file D://binil/gold/pack03/ch17/ch17-01/Ax2-Ecom-No-Security/Ecom-xtra-setup/products.json


3)Load inventory(Initial CQRS Query data - read model of inventory)
---------------------------------

mongoimport --db ecom --jsonArray --collection inventory --file D://binil/gold/pack03/ch17/ch17-01/Ax2-Ecom-No-Security/Ecom-xtra-setup/inventory.json
...
Ensure config uri is proper and first start config server before any other server 

Open ch17\ch17-01\Ax2-Ecom-No-Security\Ecom-config\src\main\resources\application.yml and update the value of the git uri: 
...
Go to "ch17\ch17-01\Ax2-Ecom-No-Security\config-repo" folder
Except ecom-registry.yml, update all other .yml file with following values:
        eureka.client.serviceUrl.defaultZone: http://localhost:8761/eureka/ (In *.yml)

Open "ch17\ch17-01\Ax2-Ecom-No-Security\config-repo\*.yml" wherever applicable, ensure RabbitMQ configuration parameters are proper:

Change in config-repo\ecom-core.properties:
	ecom.amqp.rabbit.address= localhost:5672
	ecom.amqp.rabbit.username= guest
	ecom.amqp.rabbit.password= guest
	ecom.amqp.rabbit.vhost=/
	ecom.amqp.rabbit.exchange=Ecom-exchange
	ecom.amqp.rabbit.queue=Ecom-core-queue

Change in config-repo\ecom-delivery.properties:
	ecom.amqp.rabbit.address= localhost:5672
	ecom.amqp.rabbit.username= guest
	ecom.amqp.rabbit.password= guest
	ecom.amqp.rabbit.vhost=/
	ecom.amqp.rabbit.exchange=Ecom-exchange
	ecom.amqp.rabbit.queue=Ecom-delivery-queue

Change in config-repo\ecom-history.properties:
	ecom.amqp.rabbit.address= localhost:5672
	ecom.amqp.rabbit.username= guest
	ecom.amqp.rabbit.password= guest
	ecom.amqp.rabbit.vhost=/
	ecom.amqp.rabbit.exchange=Ecom-exchange
	ecom.amqp.rabbit.queue=Ecom-order-histo-queue

Change in config-repo\ecom-product.properties:
	ecom.amqp.rabbit.address= localhost:5672
	ecom.amqp.rabbit.username= guest
	ecom.amqp.rabbit.password= guest
	ecom.amqp.rabbit.vhost=/
	ecom.amqp.rabbit.exchange=Ecom-exchange
	ecom.amqp.rabbit.queue=Ecom-product-queue

Change in config-repo\ecom-shipping.properties:
	ecom.amqp.rabbit.address= localhost:5672
	ecom.amqp.rabbit.username= guest
	ecom.amqp.rabbit.password= guest
	ecom.amqp.rabbit.vhost=/
	ecom.amqp.rabbit.exchange=Ecom-exchange
	ecom.amqp.rabbit.queue=Ecom-shipping-queue
...
Go to ch17\ch17-01\Ax2-Ecom-No-Security\Ecom-web\src\main\resources\application.yml and update the value of apigateway.url:
...
Open "ch17\ch17-01\Ax2-Ecom-No-Security\config-repo\*.yml" wherever applicable, ensure MongoDB configuration parameters are proper:
...
Open "ch17\ch17-01\Ax2-Ecom-No-Security\config-repo\*.yml" wherever applicable, ensure MySQL configuration parameters are proper:
...
Open ch17\ch17-01\Ax2-Ecom-No-Security\config-repo\ecom-product.yml and update the value
...
4)Load inventory(Initial CQRS Query data - read model of inventory)
