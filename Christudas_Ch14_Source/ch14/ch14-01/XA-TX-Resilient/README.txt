...
cd D:\Applns\apache\Derby\db-derby-10.14.1.0-bin\bin
...
------------------------------------------------
Change
ch14\ch14-01\XA-TX-Distributed\Broker-MySQL-ActiveMQ\src\main\resources\spring-sender-mysql.xml
...
Change
ch14\ch14-01\XA-TX-Resilient\Settlement-ActiveMQ-Derby\src\main\resources\spring-listener-derby.xml
...
|                                               3|     __|__      ------
|                                                |    /  |  \     1. processNewQuote  
|                          (TX)________________  |   |\_____/|    2. confirmQuote
...
|    |		     |---->|___________________|     |	 C   |    5. jmsTemplate.send(quote)
 \-->|               |                               |   T   |    6. onMessage(Quote)
     | BrokerService |     (TX)________________      |   I   |    7. insertUniqueNoErrorOnDuplicate
     |_______________|---->|                   |     |   V   |    8. settleQuote
                        4  | StockOrderService |---->|   E   |    9. reconcile Quotes processing
                           |___________________|  5  |       |   10. markSettled
                                                     |       |      (XA)_________________________    8     \
                                                     |   M   |  6  |                             |-------   | 
                                                     |   Q   |---->| SettlementListenerService   |       |  |
 Q U O T E   P R O C E S S I N G   µ S E R V I C E   |       |     |_____________________________|-----  |  |
 <------------------------------------------------   |       |                                      7  | |  |                 
                                                     |   Q   |      (XA)_________________________      | |  |
                                                     |   U   |     |                             |     | |   \ µ Service 3
                                                     |   E   | ----| QuotesTransactionService    |<----  |   /    
                                                     |   U   ||    |_____________________________|  10   |  |
                                                     |   E   ||                                          |  |
                                                      \_____/ |     (XA)_________________________        |  |
                                                         |    |    |                             |       |  |
                                                         |    |  --| QuotesReconcileService      |<------   |            
...
|           |          |           |          |              ||                 |            | However, Quote NOT Settled twice  |
 ------------------------------------------------------------  -------------------------------------------------------------------
...
|           |          |           |          |              || No Error        | No Error   | - Quote Settled second chance     |
 ------------------------------------------------------------  ------------------------------------------------------------------
| 8         | No Error | No Error  | 1st: 90  | No Error     || No Error        | No Error   | Message Received out of order!    |
|           | No Error | No Error  | 2nd: 2   | No Error     || No Error        | No Error   | However, Original order taken care|
 ------------------------------------------------------------  ------------------------------------------------------------------
